...
/**
 * Convert PDF Document Design Standard to PDF
 * Using the exact design standard it defines
 */
...
async function convertToPDF() {
  const inputPath = path.join(__dirname, '..', 'documentation', 'policies', 'PDF-DOCUMENT-DESIGN-STANDARD.md');
  const outputPath = path.join(__dirname, '..', 'documentation', 'policies', 'PDF-DOCUMENT-DESIGN-STANDARD.pdf');

  console.log('📄 Converting PDF Document Design Standard to PDF...\n');
  ...
  const introHtml = `
  <div class="intro-box">
      <div class="intro-title">Official Design Policy</div>
      <div class="intro-text">This document establishes the MANDATORY design standard for all PDF documents produced by Masaphokati Technologies (Pty) Ltd. Non-compliance is not permitted.</div>
  </div>
  `;
  ...
  <div class="cover-page">
      <div class="cover-content">
          ...
          <div class="cover-title">PDF Document Design Standard</div>
          <div class="cover-subtitle">Official Policy Document</div>
          ...
          <div class="cover-info">
              <div class="info-row"><span class="info-label">Policy Number:</span> <span class="info-value">DOC-STD-001</span></div>
              ...
              <div class="info-row"><span class="info-label">Department:</span> <span class="info-value">Documentation Standards</span></div>
              <div class="info-row"><span class="info-label">Classification:</span> <span class="info-value">Internal - Mandatory</span></div>
          </div>
  ...
  console.log('✅ PDF Document Design Standard generated successfully!');
