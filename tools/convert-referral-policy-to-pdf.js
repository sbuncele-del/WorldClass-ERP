...
/**
 * Masaphokati Technologies - Referral Policy PDF Converter
 * Uses the same template as convert-documentation-to-pdf.js
 * 
 * Usage: node tools/convert-referral-policy-to-pdf.js
 */
...
// Professional PDF styling - EXACT copy from convert-documentation-to-pdf.js
const HTML_TEMPLATE = `
<!DOCTYPE html>
<html>
<head>
...
async function convertToPdf() {
  console.log('\n📋 Masaphokati - Referral Policy PDF Generator');
  console.log('='.repeat(50));
  
  const inputPath = path.join(__dirname, '..', 'company-docs', 'REFERRAL-PARTNER-POLICY.md');
  const outputPath = path.join(__dirname, '..', 'company-docs', 'REFERRAL-PARTNER-POLICY.pdf');
  ...
  const introHtml = `
  <div class="intro-box">
      <div class="intro-title">Partner Program Policy</div>
      <div class="intro-text">10% commission on every payment received from referred clients, for the lifetime of the client relationship.</div>
  </div>
  `;
  ...
  // Generate cover page - EXACT format from convert-documentation-to-pdf.js
  const coverPageHtml = `
  <div class="cover-page">
      <div class="cover-content">
          <div class="cover-logo">SiyaBusa ERP</div>
          <div class="cover-title">Referral Partner Policy & Agreement</div>
          <div class="cover-subtitle">Partner Program</div>
          ...
          <div class="cover-info">
              ...
              <div class="info-row"><span class="info-label">Department:</span> <span class="info-value">Business Development</span></div>
              <div class="info-row"><span class="info-label">Classification:</span> <span class="info-value">Partner Document</span></div>
          </div>
