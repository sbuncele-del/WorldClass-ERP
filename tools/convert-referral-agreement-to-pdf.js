...
/**
 * Masaphokati Technologies - Referral Partner Agreement PDF Converter
 * Uses the same template as convert-documentation-to-pdf.js
 * 
 * Usage: node tools/convert-referral-agreement-to-pdf.js
 */
...
async function convertToPdf() {
  console.log('\n📋 Masaphokati Technologies - Referral Partner Agreement PDF Generator');
  console.log('='.repeat(70));
  
  const inputPath = path.join(__dirname, '..', 'company-docs', 'REFERRAL-PARTNER-AGREEMENT.md');
  const outputPath = path.join(__dirname, '..', 'company-docs', 'REFERRAL-PARTNER-AGREEMENT.pdf');
  ...
  const introHtml = `
  <div class="intro-box">
      <div class="intro-title">Legal Agreement</div>
      <div class="intro-text">This is a legally binding agreement between Masaphokati Technologies (Pty) Ltd and the Referral Partner. Please read carefully and seek independent legal advice before signing.</div>
  </div>
  `;
  ...
  <div class="cover-page">
      <div class="cover-content">
          ...
          <div class="cover-title">Referral Partner Agreement</div>
          <div class="cover-subtitle">Legal Agreement</div>
          ...
          <div class="cover-info">
              ...
              <div class="info-row"><span class="info-label">Department:</span> <span class="info-value">Legal & Compliance</span></div>
