...
import afsRoutes from './routes/afs.routes';
...
const corsOptions = {
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'X-Requested-With', 'Accept', 'Origin', 'x-tenant-id', 'x-entity-id'],
...
v1Router.use('/xero', xeroRoutes);
v1Router.use('/financial/gl-explorer', glExplorerRoutes);
v1Router.use('/financial/afs', afsRoutes);
...
v1Router.use('/contact', apiLimiter, contactRoutes); // Website Contact Form
