#!/usr/bin/env python3
"""Convert NDB Proposal - V5 POLISHED
1. Perfect Vertical Centering for Cover Page (Fix "skewed" alignment).
2. New "Card Style" for Sector Allocation (Fix "44%" issue).
3. Keeps all previous fixes (headers, contact info, proper graphics).
"""
...
# Investment Cards (Same as before - working well)
investment_box = """
...
# Operational Model (Same as before - working well)
op_model_box = """
...
# Sectors Allocation - NEW CARD DESIGN (To fix "44 mill is out"/skewed issue)
sector_box = """
...
# Governance / Org Structure (Stable Table)
org_box = """
...
<div style="background: #eef6ff; border: 2px solid #0a2540; border-radius: 8px; padding: 25px; margin: 20px 0; page-break-inside: avoid;">
    ...
    <div style="text-align: center; margin-top: 15px; font-size: 12pt; background: rgba(255,255,255,0.5); padding: 10px; border-radius: 4px;">
...
# Insert after table with seed investment return
...
# B. Operational Model
# Replace whole section between H3 and H2
...
# C. Sector Allocation - BEFORE "Conservative Mobilization Target"
...
.cover-container {
    ...
    color: white;
    text-align: center;
    /* Simulate Flexbox centering for WeasyPrint */
    display: block; 
}
.cover-content {
    position: absolute;
...
# Cover Page HTML - Wrapped for Centering
cover_page = """
<div class="cover-container">
    <div class="cover-content">
        ...
        <p style="font-size: 16pt; color: #d4af37; margin-bottom: 50px; font-weight: 300;">Investment & Development Finance Business Plan</p>
        
        <!-- Stats -->
        <table style="width: 100%; margin: 0 auto 50px auto; border-spacing: 20px; border-collapse: separate;">
            <tr>
        ...
        <div style="font-size: 11pt; line-height: 1.8; color: #e0e0e0;">
            <p style="margin: 5px 0;"><b>Presented to:</b> Strategic Investment Partners</p>
            <p style="margin: 5px 0;"><b>Prepared by:</b> Alex Tsela Global Finance</p>
            <p style="margin: 5px 0;"><b>Contact:</b> Alex@satsi.co.za | +27 66 472 5666</p>
            <p style="margin: 5px 0;"><b>Date:</b> January 2026</p>
