#!/usr/bin/env python3
"""
Generate conversational voiceovers for investor pitch using ElevenLabs
Female voice: Sarah - Mature, Reassuring, Confident
"""
...
VOICE_ID = "EXAVITQu4vr4xnSDxMaL"  # Sarah - female, confident
...
siyabusaerp.co.za - that's s-i-y-a-b-u-s-a-e-r-p dot co dot za. 
We rule. We govern. We empower. Let's build the future 
of African enterprise together. Thanks again!
"""
}

def generate_voiceover(name, text):
    ...
    data = {
        ...
        "voice_settings": {
            ...
            "style": 0.4,  # More expressive for conversational tone
...
def main():
    print("🎙️  Conversational Voiceover Generator")
    print(f"   Voice: Sarah (Female, Confident)")
    ...
    for name, script in SCRIPTS.items():
        ...
        result = generate_voiceover(name, script)
        if result:
